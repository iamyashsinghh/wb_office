        ...
        <Wrapper>
            <div className="container">
                ...
                <div className="card-container">
                    ...
                    <VendorCategoryCard bgColor={"#FAF0D7"} imgUrl={'/vendor-cat/makeup.jpeg'} title={"Makeup Atrist"} desc={"Wedding Makeup Artist"}  url={"/top-makeup-artists/delhi/all"}/>
                    <VendorCategoryCard bgColor={"#F7FFE5"} imgUrl={'/vendor-cat/mehndi.jpeg'} title={"Mehndi Artist"} desc={"Wedding Mehndi Artist"}  url={"/best-mehndi-artists/delhi/all"}/>
